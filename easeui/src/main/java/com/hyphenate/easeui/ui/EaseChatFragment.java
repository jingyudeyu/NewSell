...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected RelativeLayout rlGoodInfo;
    protected ImageView imageGood;
    protected TextView tvGoodName;
    protected TextView tvGoodPrice;
    protected TextView tvSendLink;
    protected TextView tvWantPartenr;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //  shopname=fragmentArgs.getString("shopname");
    ...
    protected void initView() {
        ...
        /*关于商品信息及发送商品链接的*/
        rlGoodInfo = (RelativeLayout) getView().findViewById(R.id.rl_good_info);
        imageGood = (ImageView) getView().findViewById(R.id.image_good);
        tvGoodName = (TextView) getView().findViewById(R.id.tv_good_name);
        tvGoodPrice = (TextView) getView().findViewById(R.id.tv_good_price);
        tvSendLink = (TextView) getView().findViewById(R.id.tv_send_link);
        tvWantPartenr = (TextView) getView().findViewById(R.id.tv_want_partenr);
...
//        messageList.setAvatarShape(1);
    ...
    protected void setUpView() {
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {//单聊
            ...
            if (chatType == EaseConstant.CHATTYPE_GROUP) {//组
                //group chat
    ...
    // protected EaseChatFragmentHelper chatFragmentHelper=new EaseChatFragmentHelper();
   ...
   /* public class EaseChatFragmentHelper{
        *//**
